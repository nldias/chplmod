// ===================================================================
// ==> dgrow provides a module to "grow" a rectangular domain on
// demand
// ===================================================================
use IO only stderr;
// -------------------------------------------------------------------
...
// -------------------------------------------------------------------
proc dgrow(
   const in i: int,      // an index of the first dimension
   ref d:domain(?),      // the domain to be grown
   const in fr: real=1.5 // the growth factor (1.2 grows by 20%, etc.)
) {
