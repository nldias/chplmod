...
use IO;
// -----------------------------------------------------------------------------
// 2024-03-19T13:00:32 extending the use of Bolz
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
...
private var
   ...
   cB = 0.22,      // constant, Bolz equation
   dB = 2.0,       // constant, Bolz equation 
   aV,             // constante, vapor transfer coeff. 
   bV,             // constante, vapor transfer. coeff. 
   eps             // emissividade                     
   : real;         
...
// -----------------------------------------------------------------------------
// --> Bolz: define the parameters of Bolz's equation
//
// Ra = (1 + cB*C**dB)*Rac
// -----------------------------------------------------------------------------
proc Bolz(
...
// -----------------------------------------------------------------------------
// --> Wind: define the parameters a,b of the mass transfer coefficient
//   
// f(u) = a + b u
// -----------------------------------------------------------------------------
proc Wind(
...
proc Radiation(
   ...
   out Rn: real               // net radiation     (W/m^2)
) {
   var epsAC = aB*((ea/Ta)**bB);   // clear-sky atmospheric emissivity
   Ra = (epsAC)*(sigma)*Ta**4;     // clear-sky atmospheric radiation
// -----------------------------------------------------------------------------
// increase of atmospheric radiation due to the presence of clouds
// eq (22) from Duarte et al (2006)
//
...
// -----------------------------------------------------------------------------
   ...
   Rn = Rs*(1.0-alb) + eps*Ra - Re;    // radiação líquida
}
// -----------------------------------------------------------------------------
