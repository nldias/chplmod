...
// ------------------------------------------------------------------------------
// --> newton: nonlinear least squares by curve fitting with the Gauss-Newton
// method
//
// Hopefully, backtracking will come from:
// https://www.cs.cmu.edu/~ggordon/10725-F12/slides/05-gd-revisited.pdf
...
// -----------------------------------------------------------------------------   
   ...
   var lamb = 1.0e-2;              // initial value of Levenberg-Marquardt's
                                   // lambda
// -----------------------------------------------------------------------------
// local array variables
// -----------------------------------------------------------------------------   
   ...
   var maux_mn: [1..m,1..n] real;  // aux (m,n)-matrix: maux_mn == WJ
   var
...
// -----------------------------------------------------------------------------
         ...
         mdiag(maux_nn,D);                // D == its diagonal as a matrix
      }
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// to calculate rho, sum h'lamb D h to vaux_n
// -----------------------------------------------------------------------------
      dot_mv(lambD,hh,vaux_n1);    // vaux_n1 == lamb D h
      dot_vtv(hh,vaux_n1,vaux_n2); // vaux_n2 == h' lamb D h
      vaux_n2 += vaux_n;           // vaux_n2 == h' lamb D h + J'W[yhat(p) - y]
...
// -----------------------------------------------------------------------------      
      ...
      if rho > epsilon_r then {
         ...
         lamb = min(lamb,1.0e7);   // but limit it
