...
// -----------------------------------------------------------------------------         
         if ((!broyden) || (mod(iiter,2*n) == 0 || chi2p > chi2p_o)) then {
...
// -----------------------------------------------------------------------------      
      ...
      // writeln("rhoden = ",rhoden);
      // writeln("chi2 = ",chi2p_o, " ",chi2p, " rho = ",rho, " lamb = ",lamb);
      // writeln("-"*80);
//      readln();
      if rho > epsilon_r then {
         p = pa ;                  // accept the update
         lamb /= 10.0;             // decrease lamb
      }
      else {                       // do not update p!
         lamb *= 10.0;             // increase lamb
