...
proc steep(
   ...
   const m = ax.size;              // the number of data points
   const n = ap.size;              // the number of parameters
   assert (ay.size == m);
   assert (aw.size == m);
   assert (asigp.size == n);
...
proc gnewton(
   ...
   const m = ax.size;              // number of data points
   const n = ap.size;              // number of parameters
   assert (ay.size == m);
   assert (aw.size == m);
   assert (asigp.size == n);
   assert (acp.shape == (n,n));
...
// =============================================================================   
   ...
   const m = ax.size;              // the number of points
   const n = ap.size;              // the number of parameters
   assert (ay.size == m);
   assert (aw.size == m);
   assert (asigp.size == n);
...
// -----------------------------------------------------------------------------   
   ...
   var pa: [1..n] real;            // auxiliary parameter vector
