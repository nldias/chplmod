...
//
// 2026-06-12T15:25:19 We don't really need rank 1 here. Making it more general.
// -----------------------------------------------------------------------------
proc nanstat2(
   ref x: [] real             // the data
...
proc xbins(
   ...
   for (xi,yi) in zip(x,y) do {
      var j : int;
      if xi == xbmax then {
         j = m-1;                       // I want xbmax counted too!
      }
      else {      
         j = ((xi - xbmin)/dxb):int;    // index of desired bin
      }
      // -----------------------------------------------------------------------
